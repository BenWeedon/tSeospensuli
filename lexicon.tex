...
\begin{itemize}
    ...
    \lexitem{thlodu}{c4}{end; comes from thlos $\rightarrow$ thlosdu $\rightarrow$ thlodu}
    \lexitem{thlos}{c4}{purple}
    \lexitem{thlosal}{c4}{sunset}
    \lexitem{thluun}{c4}{sword}
    \lexitem{kyy}{v}{love}
    ...
    \lexitem{xiln}{c3}{dog}
    \lexitem{xwaef}{c2}{cow}
    \lexitem{xwaefxwaeaef}{c2}{calf}
\end{itemize}
\end{document}
